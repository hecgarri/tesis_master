...
\begin{verbatim}
## 38780 (97%) points of the grid lead to regimes with percentage of observations < trim and were not computed
\end{verbatim}
...
## $multi
##          E df   P(Chi > E)
## 1 243.2701  4 1.833063e-51
## 
## $univ
##                                E df   P(Chi > E)
## resids.of.supermercado 169.73015  2 1.391769e-37
## resids.of.mayorista     73.53998  2 1.073978e-16
\end{verbatim}

...
\caption{Función acumulada de impulso respuesta\label{graph5.6}}\label{fig:graph5.71}
\end{figure}
...
\caption{Función acumulada de impulso respuesta\label{graph5.6}}\label{fig:graph5.72}
\end{figure}

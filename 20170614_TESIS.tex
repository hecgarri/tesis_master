...
En el caso del logaritmo de los precios mayoristas de la palta, puede apreciarse una media no constante, aunque no es directamente apreciable lo mismo para la varianza. Por otro lado, su correlograma muestra autocorrelaciones significativas más allá de 52 períodos de rezago, lo que permite afirmar que el proceso tendría una memoria prolongada y que por tanto, no es estacionario (Véase \ref{fig5.1}). 
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[H]
...
Para el caso de la serie del logaritmo del precio de la palta en supermercados, se puede observar un comportamiento bastante similar. Es decir, una media que no es constante debido claramente a una tendencia, cuya naturaleza se determina más adelante; y una memoria prolongada al observar el correlograma correspondiente.  
...
Hecho lo anterior, se procede a aplicar el contraste ERS, utilizando como en primer lugar un modelo con constante y tendencia deteminista. Al observar el cuadro \ref{fig5.5} se puede observar que para el caso de los mayoristas no se puede rechazar la hipótesis nula de raíz unitaria para ninguno de los niveles de significancia prescritos, mientras que para el caso de la serie supermercado dicha hipótesis se rechaza al menos al 5\%.  
...
{\centering \includegraphics[width=5in,height=3.5in]{figure/unnamed-chunk-11-1} 

}

\caption[Inclusión de variables escalón]{Inclusión de variables escalón}\label{fig:unnamed-chunk-11}
\end{figure}
...
{\centering \includegraphics[width=4.5in,height=3.5in]{figure/unnamed-chunk-13-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in UseMethod("{}logLik"{}): no applicable method for 'logLik' applied to an object of class "{}list"{}}}\end{kframe}
\end{knitrout}
...
## $criteria
##                    1             2             3             4
## AIC(n) -1.106843e+01 -1.112550e+01 -1.113534e+01 -1.112776e+01
## HQ(n)  -1.103447e+01 -1.107797e+01 -1.107422e+01 -1.105307e+01
## SC(n)  -1.098202e+01 -1.100453e+01 -1.097980e+01 -1.093767e+01
## FPE(n)  1.559710e-05  1.473187e-05  1.458777e-05  1.469873e-05
##                    5             6             7             8
## AIC(n) -1.113205e+01 -1.112363e+01 -1.112127e+01 -1.113702e+01
## HQ(n)  -1.104378e+01 -1.102177e+01 -1.100583e+01 -1.100800e+01
## SC(n)  -1.090740e+01 -1.086441e+01 -1.082749e+01 -1.080868e+01
## FPE(n)  1.463598e-05  1.475998e-05  1.479508e-05  1.456420e-05
##                    9            10
## AIC(n) -1.112680e+01 -1.111251e+01
## HQ(n)  -1.098419e+01 -1.095633e+01
## SC(n)  -1.076389e+01 -1.071504e+01
## FPE(n)  1.471436e-05  1.492657e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=4.5in,height=3.5in]{figure/unnamed-chunk-17-2} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eigen(C): 0 x 0 matrix}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
## 768 (1.5%) points of the grid lead to regimes with percentage of observations < trim and were not computed
## There were  2  thresholds/cointegrating combinations ( 0.050059708846582 / 1.0645821961266 ,  0.050059708846582 / 1.0645821961266 ,  ) 
## which minimize the SSR in the first search, the first one  0.05005971   1.064582  was taken
\end{verbatim}
...
{\centering \includegraphics[width=4.5in,height=3.5in]{figure/unnamed-chunk-19-1} 
...
## Chi-squared = 734.49, df = 4, p-value < 2.2e-16
## 
## 
## $Skewness
## 
...
## 
## data:  Residuals of VAR object mono
## Chi-squared = 36.511, df = 2, p-value = 1.18e-08
## 
## 
## $Kurtosis
## 
...
## 
## data:  Residuals of VAR object mono
## Chi-squared = 697.98, df = 2, p-value < 2.2e-16
## $multi
##          E df  P(Chi > E)
## 1 261.0204  4 2.74849e-55
## 
## $univ
##                      E df   P(Chi > E)
## supermercado 173.32237  2 2.309544e-38
## mayorista     87.69806  2 9.049166e-20
\end{verbatim}
\end{kframe}
\end{knitrout}

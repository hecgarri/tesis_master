...
{\centering \includegraphics[width=5in,height=3.5in]{figure/unnamed-chunk-15-1} 

}

\caption[Número de Rezagos para el contraste de Independencia]{Número de Rezagos para el contraste de Independencia}\label{fig:unnamed-chunk-151}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics[width=5in,height=3.5in]{figure/unnamed-chunk-15-2} 

}

\caption[Número de Rezagos para el contraste de Independencia]{Número de Rezagos para el contraste de Independencia}\label{fig:unnamed-chunk-152}
\end{figure}

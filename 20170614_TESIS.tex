...
{\centering \includegraphics[width=5in,height=3.5in]{figure/unnamed-chunk-14-1} 

}

\caption[Número de Rezagos para el contraste de Independencia]{Número de Rezagos para el contraste de Independencia}\label{fig:unnamed-chunk-141}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics[width=5in,height=3.5in]{figure/unnamed-chunk-14-2} 

}

\caption[Número de Rezagos para el contraste de Independencia]{Número de Rezagos para el contraste de Independencia}\label{fig:unnamed-chunk-142}
\end{figure}
...
## 2.91 distributed as chi square with 2 df.
## The p-value of the test statistic is: 0.23 
## 
...
{\centering \includegraphics[width=4.5in,height=3.5in]{figure/unnamed-chunk-15-1} 
...
{\centering \includegraphics[width=4.5in,height=3.5in]{figure/unnamed-chunk-20-1} 

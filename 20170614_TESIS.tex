...
\chapter{El mercado de la Palta en Chile}
...
{\centering \includegraphics[width=5in,height=3.5in]{figure/unnamed-chunk-21-1} 

}

\caption{Número de Rezagos para el contraste de Independencia\label{fig5.6}}\label{fig:unnamed-chunk-21}
\end{figure}
...
{\centering \includegraphics[width=4.5in,height=3.5in]{figure/unnamed-chunk-29-1} 

...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in x[, (1 + cs[i]):cs[i + 1]] <- xx: número de items para para sustituir no es un múltiplo de la longitud del reemplazo}}\end{kframe}
\end{knitrout}
...
## 1.09 distributed as chi square with 2 df.
## The p-value of the test statistic is: 0.58 
## 
...
\caption[Número de Rezagos para el contraste de Independencia]{Número de Rezagos para el contraste de Independencia}\label{fig:unnamed-chunk-13}
\end{figure}

...
setwd( "/home/hector/GoogleDrivePersonal/Master/Tesis")
...
<<fig-1,echo=F,fig.cap='Evolución de precios del tomate de larga vida de primera calidad,2008-2016', out.width='6.5in', out.height='3.5in', fig.align='center', fig.pos='H'>>=
...
plot(precio_mayorista, lty=2 ,ylab="Precio tomate mayorista ($/kilo)", 
     xlab="Tiempo")
...
plot(precio_supermercado, lty=2 ,ylab="Precio tomate supermercado ($/kilo)", 
     xlab="Tiempo")
...
a integrated twice cumulated of order stochastic two, or in trend, shorthand 
t
 s=1 notation 
i=1 s
 εi . pt We ∼ say I(2).

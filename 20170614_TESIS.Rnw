...
Determinar la existencia de asimetría en la transmisión de precios en el mercado de la palta en Chile. 
...
\section{Transmisión de precios}
...
\section{Modelos y contrastes estadísticos utilizados en esta tesis}

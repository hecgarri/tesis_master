...
ers1 = ur.ers(y1, type = c("P-test"), model="trend", lag.max = 5)

ers2 = ur.ers(y2, type = c("P-test"), model="trend", lag.max = 5)

ers11 = ur.ers(y1, type = c("P-test"), model="constant", lag.max = 5)

ers21 = ur.ers(y2, type = c("P-test"), model="constant", lag.max = 5)
@
...
vecm1 = ca.jo(datos, type=c("trace"), ecdet=c("const"), K=24,
              spec="longrun", season=NULL)

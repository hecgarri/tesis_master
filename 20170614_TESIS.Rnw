...
mono = TVECM(datos[,c(2,1)], lag=8, nthresh = 1, trim=0.05, ngridBeta = 200, ngridTh = 200, plot=TRUE, include=c("none"), common = "All", beta = list(int = c(-0.5,1.5)), beta0=rep(1,dim(datos)[1]))
